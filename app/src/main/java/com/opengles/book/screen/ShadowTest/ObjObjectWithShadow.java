 ...
 *         .obj 文件对象 绘制
 */
public class ObjObjectWithShadow implements ObjectDrawable {
	...
	String TAG = ObjObjectWithShadow.this.getClass().getName();
   ...
   // 总变换矩阵属性
    ...
    public ObjObjectWithShadow(Context context, ObjModel objModel)
	...
	public void draw() {
       ...
       cameraMVPUniform.bind();
		...
		for (int i = 0; i < size; i++) {
            ...
            GLES20.glUniform1i(objTextureHandler, 1);
	...
	protected void onDraw(int mProgram)
	{
        ...
        GLES20.glUniform1i(shadowTextureHandler, 0);
	}
