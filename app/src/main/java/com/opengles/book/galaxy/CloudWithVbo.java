 ...
 * 
 * @author davidleen29 
 * @create : 2014-4-20 上午11:23:37
 * @{ 云层效果}
 */
public class CloudWithVbo implements ObjectDrawable
{
...
//	float zAngle = 0;// ��z����ת�ĽǶ�
	...
	public CloudWithVbo(Context mv)
	{
	...
	{
		// ���ض�����ɫ���Ľű�����
		mVertexShader = ShaderUtil.loadFromAssetsFile("cloud_vertex.glsl",
				mv.getResources());
		// ����ƬԪ��ɫ���Ľű�����
		mFragmentShader = ShaderUtil.loadFromAssetsFile("cloud_frag.glsl",
				mv.getResources());
		// ���ڶ�����ɫ����ƬԪ��ɫ����������
