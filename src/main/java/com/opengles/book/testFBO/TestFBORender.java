...
public class TestFBORender implements GLSurfaceView.Renderer
{
     ...
     */
    public TestFBORender(final Context activityContext)
    {
    ...
    public void onSurfaceCreated(GL10 glUnused, EGLConfig config)
    {
        ...
        ShaderUtil.loadFromAssetsFile("testfbo/v_testfbo.glsl",mActivityContext.getResources());
        final String fragmentShader =  ShaderUtil.loadFromAssetsFile("testfbo/f_testfbo.glsl",mActivityContext.getResources());
