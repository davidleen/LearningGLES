...
import com.opengles.book.ObjectLoader;
...
public class Teapot implements ObjectDrawable {
	...
	{
		loader = new ObjectLoader(context.getResources(), "cube.obj");

		textureId = ShaderUtil.loadTextureWithUtils(context.getResources()
				.openRawResource(R.raw.crate));

		// ���ض�����ɫ���Ľű�����
		mVertexShader = ShaderUtil.loadFromAssetsFile("teapot_vertex.glsl",
				context.getResources());
		// ����ƬԪ��ɫ���Ľű�����
		mFragmentShader = ShaderUtil.loadFromAssetsFile("teapot_frag.glsl",
				context.getResources());
		// ���ڶ�����ɫ����ƬԪ��ɫ����������
	...
	public void bind() {
		...
		indicsLength = loader.triangleCount * 3;
	...
	private void LoadedObjectVertexNormalTexture()
	{
